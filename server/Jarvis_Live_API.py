...
# u = requests.get("https://api.elevenlabs.io/v1/user", headers={"xi-api-key": api_key}).json()
...
class Jarvis:
    def __init__(self, socketio_instance=None, client_sid=None):
        ...
        Your name is Jarvis, which stands for Just A Rather Very Intelligent System.
        ...
        Your creator's name is Pranav, and you address him as "Pranav" and you also speak with an American accent.
